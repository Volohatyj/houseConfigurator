...
export class House {
    ...
    set depth(newDepth: number) {
        this._width = newDepth;
        console.log(`Будинок змінено. Нова ширина: ${newDepth}м.`);
        // У реальному проекті тут буде виклик this._grid.regenerate();
    }
...
// ТЕСТУЙТЕ ТУТ:
myHouse.addColumn(3, 1);
// myHouse.addColumn(-3, 1);
myHouse.addColumn(0, 1);
// myHouse.removeColumn(1);
myHouse.width = 15;
